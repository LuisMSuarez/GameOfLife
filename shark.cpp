...
Shark::Shark(World &world, Cell &cell, uint32_t reproductionTimer, uint32_t maxAge, std::string resourcePath)
    : Creature(world, cell, reproductionTimer, maxAge, resourcePath)
{
}
